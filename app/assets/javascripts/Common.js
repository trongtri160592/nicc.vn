!function (t) {
    ...
    void 0 === (n = function (t) {
        ...
        return {
            init: function () {
                var t;
                n || (t = "/", "undefined" != typeof s && s.pageName && (t = s.pageName), e(".on-this-page").each(function (i, n) {
        ...
        !function () {
            ...
            e(function () {
                ...
                r.on("mouseenter.analytics", ".nav-item", function (t) {
                    ...
                    if (s.is(":visible")) {
                        var i = e(this), n = "" + location.pathname.toLowerCase(), o = i.text(),
                    ...
                    var n = e(this), o = "" + location.pathname.toLowerCase(),
